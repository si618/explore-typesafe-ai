...
| Claude wrote the hand-case labels and Claude reviewed escalations, so shared blind spots could inflate agreement ([issue #1](https://github.com/si618/explore-typesafe-ai/issues/1)) | [Independent labels](independent-labels.md): a blinded sample of 15 cases per scenario labelled by a different model family (not a clinician review) |
