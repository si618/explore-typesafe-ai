...
**System One**{ #system-one } / **System Two**{ #system-two }
...
| --- | --- | --- | --- |
| **Choice**{ #choice } | Which one of these options? | `choice`, a probability per option, `confidence` | Who should handle this patient message? |
| **Score**{ #score } | Where on this ordered scale? | `score` (a probability-weighted level, can be fractional), probabilities per level, `confidence` | How worried should the ward team be (levels 0–3)? |
| **Noul**{ #noul } | Is this statement true? | `noul`: the probability of yes (0–1) | Does the note describe new confusion? |
...
**Confidence gate**{ #confidence-gate } / **escalation**
...
**Escalation band**{ #escalation-band }
...
**Duplicate therapy**{ #duplicate-therapy } / **interaction**{ #interaction }
...
**STEMI**{ #stemi } / **NSTEMI**{ #nstemi } / **PCI**{ #pci }
